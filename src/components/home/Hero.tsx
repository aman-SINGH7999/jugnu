...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center text-center bg-gradient-to-br sm:bg-gradient-to-r from-blue-900 to-green-500 text-white">
      ...
      <div className="max-w-3xl px-6 z-20">
        ...
        <Link
          href="/tests"
          className="px-6 py-3 rounded-lg bg-yellow-400 text-black font-semibold hover:bg-yellow-500 z-50"
        >
          Start a Test
        </Link>
      </div>
      ...
      <div className="absolute -z-0 bg-blue-700/10 left-10 top-40 w-52 h-52 rounded-bl-full rotate-45"></div>
      <div className="absolute -z-0 bg-green-700/20 left-40 top-80 w-96 h-96 rounded-b-full -rotate-[25deg]"></div>
      <div className="absolute -z-0 bg-blue-700/5 right-70 -top-30 w-96 h-96 rounded-full"></div>
      <div className="absolute -z-0 bg-blue-700/5 right-110 bottom-20 w-96 h-96 rounded-bl-full rotate-45"></div>
